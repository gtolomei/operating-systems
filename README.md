...
|------------|------|-----------------------------------------------|----------------|
| Lezione 1  | 27/09/2022 | Concetti Base e Storia dei Sistemi Operativi | [slides: <a href="./lectures/slides/01_Basics_and_History.pdf" target="_blank">PDF</a>] |
| Lezione 2  | 29/09/2022 | Relazione tra Sistema Operativo e Macchina Fisica | [slides: <a href="./lectures/slides/02_Computer_Architecture_and_OS_Structures.pdf" target="_blank">PDF</a>]|
