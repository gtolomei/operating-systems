...
## News
- <u><strong>IMPORTANTE:</strong></u> Gli studenti che seguiranno le lezioni in **modalità a distanza** sono pregati di pazientare ancora un po': non appena tutte le istruzioni per l'accesso alle videoconferenze online verranno stabilite in modo definitivo dagli organi competenti, saranno immediatamente rese disponibili sia su questa pagina che sulla [bacheca del docente](https://corsidilaurea.uniroma1.it/it/users/gabrieletolomeiuniroma1it).
