...
La prova d'esame scritta relativa all'appello straordinario dell'a.a. 2023-24 si svolgerà **giovedì 17/10/2024** dalle ore **10:00** alle ore **11:00** presso l'**Aula 16** dei laboratori situati in via Tiburtina, 205 ([mappa](https://goo.gl/maps/TgnJCWDfx2VQRo4u5)).Tutti gli studenti accreditati a partecipare alla prova straordinaria dovranno **obbligatoriamente** registrarsi sull'apposito verbale Infostud (**948712**). **Le registrazioni resteranno aperte dal 24/9/2024 al 15/10/2024**.<br/>
